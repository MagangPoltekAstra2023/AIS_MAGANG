<aside class="right-side">
    <section class="content-header">
        <ol class="breadcrumb">
            ...
            <li><a href="#"><strong>Edit Component</strong></a></li>
        </ol>
    </section>
    ...
    <section class="content">
        ...
        echo form_open('samara/master_component_c/update_component', 'class="form-horizontal"');
        ?>
        <div class="row">
            <div class="col-md-12">
                <div class="grid">
                    <div class="grid-header">
                        ...
                        <span class="grid-title"><strong>EDIT</strong> COMPONENT</span>
                    ...
                    <div class="grid-body">
                            ...
                            <div class="col-sm-5">
                                <select name="INT_LINE_ID" id="line" class="form-control" style="width:400px" >                                
                                    ...
                                    foreach ($data_line as $isi) {
                                        ...
                                        <?php
                                        if($data->INT_LINE_ID == $isi->INT_ID){
                                            echo ' selected';
                                        }
                                        ?>><?php echo $isi->CHR_LINE_NAME; ?></option>
                                        <?php
                                    }
                                    ?> 
                                </select>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <input name="CHR_COMPONENT_NAME" class="form-control" required type="text" style="width: 400px;" value="<?php echo $data->CHR_COMPONENT_NAME; ?>">
                            </div> 
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <input name="CHR_COMPONENT_DESC" class="form-control" required type="text" style="width: 400px;" value="<?php echo $data->CHR_COMPONENT_DESC; ?>">
                            </div> 
                        </div>
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-3 col-sm-5">
                                <div class="btn-group">
                                    ...
                                    <?php echo anchor('samara/master_component_c', 'Cancel', 'class="btn btn-default" data-toggle="tooltip" data-placement="right" title="Back to manage"'); 
                                    echo form_close();
                                    ?>
                                </div>
                            </div>
